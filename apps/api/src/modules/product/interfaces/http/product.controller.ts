...
// DTOs
import { GetProductsDto } from '@/modules/product/interfaces/http/dtos/request/get-products.dto';
import { CreateProductDto } from '@/modules/product/interfaces/http/dtos/request/create-product.dto';
import { UpdateProductDto } from '@/modules/product/interfaces/http/dtos/request/update-product.dto';
import { ProductResponseDto } from '@/modules/product/interfaces/http/dtos/response/product-response.dto';
import { PaginatedProductsResponseDto } from '@/modules/product/interfaces/http/dtos/response/paginated-products-response.dto';
