...
|[**addressControllerFind**](#addresscontrollerfind) | **GET** /api/addresses | Get my addresses|
...
const { status, data } = await apiInstance.addressControllerFind();
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
|**200** | List of addresses retrieved successfully |  -  |
|**400** | Invalid input data or validation failed |  -  |
|**401** | Authentication required |  -  |
|**403** | Insufficient permissions |  -  |
|**500** | Internal server error |  -  |
