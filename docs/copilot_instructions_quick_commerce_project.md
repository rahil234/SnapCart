...
This file defines **global instructions** for AI copilots and contributors working on this project. The goal is to avoid re‑prompting architectural, domain, and convention details every time.
...
6. Resolve `customerId` via **CustomerResolver**
