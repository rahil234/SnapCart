...
function SearchPage() {
    ...
    const handlePriceRangeChange = useCallback((value: number[]) => {
        setSearchParams((prevParams) => {
            const params = Object.fromEntries(prevParams.entries());
            return {
                ...params, minPrice: value[0].toString(), maxPrice: value[1].toString()
            };
        });
    }, [setSearchParams]);
                ...
                <div className="w-full md:w-64 space-y-4">
                    ...
                    <div>
                        ...
                        <Slider
                            ...
                            max={1000}
                            step={10}
                            defaultValue={[parseInt(searchParams.get('minPrice') || '0'), parseInt(searchParams.get('maxPrice') || '1000')]}
                    ...
                    <div>
                        ...
                        <Select onValueChange={handleSortChange} defaultValue={searchParams.get('sort') || 'name.asc'}>
                            <SelectTrigger>
...
const ProductsTable = React.memo(function ProductsTable() {
    ...
    const { data: products = [], isLoading, error } = useQuery({
        ...
        queryFn: () => productEndpoints.searchProducts({ query, category, minPrice, maxPrice, sortBy })
    });
