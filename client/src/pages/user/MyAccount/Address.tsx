...
function AddressesSection({ addresses: initialAddresses }: { addresses: Address[] }) {
        ...
        <Card key={field.id} className="mb-4">
          <CardContent className="pt-4">
            ...
            <div className="mt-2 flex justify-end space-x-2">
              ...
              <Button type="button" variant="destructive" size="sm" onClick={() => handleRemoveAddress(index)}>
